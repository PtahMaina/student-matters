...
function toFormData(obj, formData, options) {
    ...
    if (value && !path && typeof value === 'object') {
      if (_utils.default.endsWith(key, '{}')) {
        ...
        arr.forEach(function each(el, index) {
          !_utils.default.isUndefined(el) && formData.append( // eslint-disable-next-line no-nested-ternary
  ...
  function build(value, path) {
    ...
    _utils.default.forEach(value, function each(el, key) {
      const result = !_utils.default.isUndefined(el) && visitor.call(formData, el, _utils.default.isString(key) ? key.trim() : key, path, exposedHelpers);
...
function buildURL(url, params, options) {
  ...
  const serializerParams = _utils.default.isURLSearchParams(params) ? params.toString() : new _AxiosURLSearchParams.default(params, options).toString(_encode);
...
Object.assign(AxiosHeaders.prototype, {
  set: function (header, valueOrRewrite, rewrite) {
    ...
    function setHeader(_value, _header, _rewrite) {
      ...
      if (_utils.default.isArray(_value)) {
  ...
  toJSON: function () {
    ...
    _utils.default.forEach(Object.assign({}, this[$defaults] || null, this), (value, header) => {
      ...
      obj[header] = _utils.default.isArray(value) ? value.join(', ') : value;
    });
...
exports.studentLogin = exports.logout = exports.login = exports.dvcLogin = exports.deanLogin = exports.codLogin = exports.adminLogin = void 0;
...
var studentLogin = /*#__PURE__*/function () {
  ...
  return function studentLogin(_x3, _x4) {
...
var codLogin = /*#__PURE__*/function () {
  ...
  return function codLogin(_x7, _x8) {
...
var deanLogin = /*#__PURE__*/function () {
  ...
  return function deanLogin(_x9, _x10) {
...
var dvcLogin = /*#__PURE__*/function () {
  ...
  return function dvcLogin(_x11, _x12) {
    return _ref6.apply(this, arguments);
  };
}();

exports.dvcLogin = dvcLogin;
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"special.js":[function(require,module,exports) {
"use strict";
...
var special = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(name, regNo, session, sponsorship, phone, grounds, yearSem, monthYear, unitCode, unitName, catsAssgnDone) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === "success") {
              (0, _alerts.showAlert)("success", "Information Submitted Successfully");
              window.setTimeout(function () {
                location.assign("/activities");
              }, 1500);
            }
  ...
  return function special(_x, _x2, _x3, _x4, _x5, _x6, _x7, _x8, _x9, _x10, _x11) {
    return _ref.apply(this, arguments);
  };
}();
...
function addRow() {
  ...
  var newRow = document.createElement("tr"); // create cells for the new row and append them to the row
  ...
  newRow.appendChild(cell3); // add input fields to the cells for capturing data

  cell1.innerHTML = "<input type='text' name='input'>";
  cell2.innerHTML = "<input type='text' name='input'>";
  cell3.innerHTML = "<input type='text' name='input'>"; // get the existing table and append the new row to it
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"approve.js":[function(require,module,exports) {
"use strict";
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            ...
            (0, _alerts.showAlert)("error", "Error trying to approve! Try again.");
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"leave.js":[function(require,module,exports) {
"use strict";
...
var leave = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(name, regNo, session, sponsorship, phone, leaveDuration, leavePeriod, resumption, catsDone, assignDone) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
  ...
  return function leave(_x, _x2, _x3, _x4, _x5, _x6, _x7, _x8, _x9, _x10) {
    return _ref.apply(this, arguments);
  };
}();

exports.leave = leave;
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"zote.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.dvc = exports.dean = exports.admin = void 0;
...
var admin = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(matter) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === "success") {
              (0, _alerts.showAlert)("success", "Updated And Pushed To Dean Successfully");
              window.setTimeout(function () {
                location.assign("/activities");
              }, 1500);
            }
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 4:
            ...
            if (res.data.status === "success") {
              (0, _alerts.showAlert)("success", "Updated And Pushed To DvC Successfully");
              window.setTimeout(function () {
                location.assign("/activities");
              }, 1500);
            }
...
var dvc = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(comments) {
    var res;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
...
var staffLoginForm = document.querySelector(".staffLogin-form");
var logOutBtn = document.querySelector(".nav__el--logout");
var userDataForm = document.querySelector(".form-user-data");
var userPasswordForm = document.querySelector(".form-user-password");
var signupForm = document.querySelector(".form--signup");
var submit = document.querySelector(".btn--green");
var specialForm = document.querySelector(".form--special");
var leaveForm = document.querySelector(".form--leave");
var approveBtn = document.querySelector(".button4");
var loginStudent = document.querySelector(".button1");
var loginStaff = document.querySelector(".button2");
var adminForm = document.querySelector(".form--admin");
var deanForm = document.querySelector(".form--dean");
var dvcForm = document.querySelector(".form--dvc");
var addRowBtn = document.getElementById("addRowBtn");
var table = document.getElementById("myTable"); // //DELEGATION

if (loginForm) loginForm.addEventListener("submit", function (e) {
  e.preventDefault(); // const regNo = document.getElementById("regNo").value;

  var email = document.getElementById("email").value;
  var password = document.getElementById("password").value;
  (0, _login.login)(email, password);
});
if (loginStudent) loginStudent.addEventListener("submit", function (e) {
  e.preventDefault(); // const regNo = document.getElementById("regNo").value;
...
if (loginStaff) loginStaff.addEventListener("submit", function (e) {
  e.preventDefault();
  var email = document.getElementById("email").value;
  var password = document.getElementById("password").value;
  (0, _login.login)(email, password);
...
if (specialForm) {
  specialForm.addEventListener("submit", function (e) {
    ...
    var grounds = document.getElementById("grounds").value;
    ...
    var catsAssgnDone = document.getElementById("catsAssgnDone").value;
    var inputs = table.querySelectorAll("input");
    var data = {};
    inputs.forEach(function (input) {
      data[input.name] = input.value;
    });
    (0, _special.special)(name, regNo, session, sponsorship, phone, grounds, yearSem, monthYear, unitCode, unitName, catsAssgnDone, inputs, data);
  });
}
...
if (leaveForm) {
  leaveForm.addEventListener("submit", function (e) {
    ...
    var resumption = document.getElementById("resumption").value;
    var catsDone = document.getElementById("catsDone").value;
    var assignDone = document.getElementById("assignDone").value;
    (0, _leave.leave)(name, regNo, session, sponsorship, phone, leaveDuration, leavePeriod, resumption, catsDone, assignDone);
  });
} // if (approveBtn) approveBtn.addEventListener("click", approve);


if (addRowBtn) {
  addRowBtn.addEventListener("click", _special.addRow);
