...
var special = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(regNo, department, programme, year, grounds, yearSemExamTime, monthYearOfExam, unitCode, unitName, catsAssgnDone) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              ...
              data: {
                ...
                year: year,
                grounds: grounds,
                yearSemExamTime: yearSemExamTime,
                monthYearOfExam: monthYearOfExam,
                unitCode: unitCode,
                unitName: unitName,
...
var specialForm = document.querySelector(".form--special"); // //DELEGATION
...
if (specialForm) {
  specialForm.addEventListener("submit", function (e) {
    ...
    var yearSemExamTime = document.getElementById("yearSemExamTime").value;
    var monthYearOfExam = document.getElementById("monthYearOfExam").value;
    ...
    (0, _special.special)(regNo, department, programme, year, grounds, yearSemExamTime, monthYearOfExam, unitCode, unitName, catsAssgnDone);
  });
}
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "34955" + '/');
