...
exports.studentLogin = exports.staffLogin = exports.logout = exports.login = void 0;
...
var staffLogin = /*#__PURE__*/function () {
  ...
  return function staffLogin(_x5, _x6) {
...
function myFunction() {
  ...
  var table = document.getElementById("myTable"); // Create row element

  var row = document.createElement("tr"); // Create cells

  var c1 = document.createElement("td");
  var c2 = document.createElement("td");
  var c3 = document.createElement("td");
  var c4 = document.createElement("td"); // Insert data to cells

  c1.innerText = "Elon";
  c2.innerText = "42";
  c3.innerText = "Houston";
  c4.innerText = "C++"; // Append cells to row

  row.appendChild(c1);
  row.appendChild(c2);
  row.appendChild(c3);
  row.appendChild(c4); // Append row to table body
...
var buttonRow = document.querySelector(".button3");
...
if (specialForm) {
  specialForm.addEventListener("submit", function (e) {
    ...
    (0, _special.special)(name, regNo, session, sponsorship, phone, grounds, yearSem, monthYear, unitCode, unitName, catsAssgnDone);
  });
}
